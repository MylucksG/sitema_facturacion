...
function ProductTable({ showAdvanceSearch = false }) {
  ...
  // Se invoca cuando el usuario hace clic para solicitar otra página.
  ...
  useEffect(() => {
    // Obtener elementos de otros recursos.
            ...
            currentItems.map((product) => (
              <div className={defaultTdWrapperStyle} key={product.id}>
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>ID de producto</div>
                ...
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>Nombre</div>
                  <div className={defaultTdContent}>
                ...
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>Precio</div>
                  <div className={defaultTdContent}>
                    <span className="whitespace-nowrap text-ellipsis overflow-hidden">
                      {product.amount}
                    </span>
                ...
                <div className={defaultTdActionStyle}>
                  <div className={defaultTdContentTitleStyle}>Acción</div>
                  <div className={defaultTdContent}>
                    <Menu
                      menuButton={
                        <MenuButton>
